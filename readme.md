...
- **Output files**: files generated by scGET analysis. They are stored in a directory named as the directory of input files, located where the analysis has started.
